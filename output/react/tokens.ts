...
export const dimensionPaths = /** @type {const} */ ([
  ...
  'numbers.dimension.fixed.Number',
...
export const tokens = /** @type {const} */ ({
  ...
  'numbers.dimension.fixed.zero': { desktop: '0px', mobile: '0px' },
  ...
  'theme.theme.size.border.radius.xs': { Danland: '8px', Prism: '0px', Traum: '4px' },
  ...
  'numbers.dimension.fixed.Number': { desktop: '0px', mobile: '98765px' },
